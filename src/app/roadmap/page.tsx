...
const FEITO = [
  ...
  'Resumo fático com triagem de urgência e hipossuficiência',
  'Checklist documental inteligente por área e por caso',
  ...
  'Credenciamento do advogado (edital OAB/PR + PGE)',
...
const ROADMAP = [
  ...
  { t: 'Distribuição real integrada ao sistema de dativos da OAB/PR', d: 'Cruzamento das nomeações com o credenciamento e a escala oficial; hoje é simulado.' },
